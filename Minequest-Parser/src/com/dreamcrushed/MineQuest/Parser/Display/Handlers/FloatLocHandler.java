...
public class FloatLocHandler extends FieldHandler {

	JTextField[] textFields;

	public FloatLocHandler(QuestLine line, LineDisplay display, FieldDefinition fDef) {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				FloatLoc.setLocListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						message.close();
						for (int i = 0; i < 3; i++) {
							textFields[i].setText(FloatLoc.location[i] + "");
						}
					}
				});
